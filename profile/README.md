...
the **Arduino IDE** (Integrated Development Environment) via the [Library Manager](/image/Arduino-IDE-MTD2A-library-examples.png). 12 use case examples have been prepared.
<br/>
